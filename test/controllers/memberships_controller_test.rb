...
class MembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create membership" do
    assert_difference('Membership.count') do
      post memberships_url, params: { membership: { description: @membership.description, name: @membership.name, specialty_max: @membership.specialty_max } }
    end
  ...
  test "should update membership" do
    patch membership_url(@membership), params: { membership: { description: @membership.description, name: @membership.name, specialty_max: @membership.specialty_max } }
