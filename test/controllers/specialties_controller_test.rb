...
class SpecialtiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialty" do
    assert_difference('Specialty.count') do
      post specialties_url, params: { specialty: { description: @specialty.description, name: @specialty.name } }
    end
  ...
  test "should update specialty" do
    patch specialty_url(@specialty), params: { specialty: { description: @specialty.description, name: @specialty.name } }
